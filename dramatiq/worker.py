...
#: Currently processed messages are included in the count. When set to "1" a new message
#: is only fetched once a previous one is done.
#: If unset two times the number of configured worker threads are prefetched.
