...
class Middleware:
    ...
    def before_ack(self, broker: Broker, message: Message) -> None:
        """Called before a message is acknowledged."""

    def after_ack(self, broker: Broker, message: Message) -> None:
        """Called after a message has been acknowledged."""

    def before_nack(self, broker: Broker, message: Message) -> None:
    ...
    def before_delay_message(self, broker: Broker, message: Message) -> None:
