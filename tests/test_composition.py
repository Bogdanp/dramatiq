...
def test_pipe_ignore_applies_to_receiving_message(stub_broker, stub_worker, result_backend):
    ...
    # Result of first message should NOT be passed as argument to the second message
    # and result of second message should be passed as argument to the third message
